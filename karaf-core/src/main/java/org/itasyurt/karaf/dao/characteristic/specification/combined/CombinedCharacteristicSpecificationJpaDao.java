...
@Repository
public class CombinedCharacteristicSpecificationJpaDao extends VersionedEntityJpaDao<CombinedCharacteristicSpecification> implements CombinedCharacteristicSpecificationDao {
